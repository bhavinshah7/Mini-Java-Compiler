...
public class CodeGenerator implements Visitor<String> {
	...
	public String visit(IfThenElse n) {
		...
		StringBuilder sb = new StringBuilder();
		String labelElze = LABEL + getNextLabel();
		String labelAfter = LABEL + getNextLabel();

		sb.append("; if statement" + "\n");
		sb.append(n.getExpr().accept(this) + "\n");
		// sb.append("iconst_0" + "\n");

		sb.append("ifeq " + labelElze + "\n");
		sb.append(n.getThen().accept(this) + "\n");
		sb.append("goto " + labelAfter + "\n");
		sb.append(labelElze + ":" + "\n");
		sb.append(n.getElze().accept(this) + "\n");
		sb.append(labelAfter + ":" + "\n");
	...
	public String visit(MainClass mc) {
		...
		sb.append(";" + "\n");
		sb.append("; standard initializer (calls java.lang.Object's initializer)" + "\n");
		sb.append(";" + "\n");
	...
	public String visit(ClassDeclExtends cd) {
		...
		sb.append(";" + "\n");
		sb.append("; standard initializer (calls " + currClass.parent() + "'s initializer)" + "\n");
		sb.append(";" + "\n");
		sb.append(".method public <init>()V" + "\n");
		sb.append("aload_0" + "\n");
